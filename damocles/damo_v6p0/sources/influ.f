...
C
C***********************************************************************
C DAMOCLES VERSION 5.8     16/08/94  O. QUIQUEMPOIX (LNH)   30 87 78 70
C
C Copyright EDF 1994
C
C JMH LE 14/01/2008 : CORRECTION : DANS MOTCH1(1:LCAR) , LCAR NE DOIT
C                                  PAS DEPASSER 10
C
C***********************************************************************
C
...
C
         ...
         CALL MAJUS(FIELD)
C
C  NOTE JMH LE 13/11/2001 : SUPPRESSION D'UN CONTROLE OBSOLETE
C  LE DEUXIEME CHAMP SUBMIT PEUT ETRE DIFFERENT DE FOR...
C  (CAS DE SUBIEF)
C
