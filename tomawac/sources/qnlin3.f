...
!
!.....Variables for spectral-angular interpolation of the spectrum
      INTEGER           LBUF  , DIMBUF
...
!=======================================================================
      DO IP=1,NB_NOD
        ...
        DO JF=1,NF
          DO JT=1,NT
            IF (F(IP,JT,JF).GT.AUX00) AUX00=F(IP,JT,JF)
          ENDDO
        ENDDO
...
!...............Computes the spectrum values in 1, 2, 3
                SP1P  =F(IP,JT1P  ,JFM1)*CF1
                SP1P2P=F(IP,JT1P2P,JFM2)*CF2
                SP1P3M=F(IP,JT1P3M,JFM3)*CF3
                SP1P2M=F(IP,JT1P2M,JFM2)*CF2
                SP1P3P=F(IP,JT1P3P,JFM3)*CF3
!
...
!...............Sum of Qnl4 term in the table TSTOT
                TSTOT(IP,JT    ,JFM0)=TSTOT(IP,JT    ,JFM0)+AUX00 *CP0
                TSTOT(IP,JT1P  ,JFM1)=TSTOT(IP,JT1P  ,JFM1)+AUX00 *CP1
                TSTOT(IP,JT1P2P,JFM2)=TSTOT(IP,JT1P2P,JFM2)-Q_2P3M*CP2
                TSTOT(IP,JT1P2M,JFM2)=TSTOT(IP,JT1P2M,JFM2)-Q_2M3P*CP2
                TSTOT(IP,JT1P3M,JFM3)=TSTOT(IP,JT1P3M,JFM3)-Q_2P3M*CP3
                TSTOT(IP,JT1P3P,JFM3)=TSTOT(IP,JT1P3P,JFM3)-Q_2M3P*CP3
!
!...............Sum of the term dQnl4/dF in the table TSDER
                TSDER(IP,JT    ,JFM0)=TSDER(IP,JT    ,JFM0)+AUX09 *CP0
                TSDER(IP,JT1P  ,JFM1)=TSDER(IP,JT1P  ,JFM1)+AUX10 *CP1
                TSDER(IP,JT1P2P,JFM2)=TSDER(IP,JT1P2P,JFM2)-Q2PD2P*CP2
                TSDER(IP,JT1P2M,JFM2)=TSDER(IP,JT1P2M,JFM2)-Q2MD2M*CP2
                TSDER(IP,JT1P3M,JFM3)=TSDER(IP,JT1P3M,JFM3)-Q2PD3M*CP3
                TSDER(IP,JT1P3P,JFM3)=TSDER(IP,JT1P3P,JFM3)-Q2MD3P*CP3
!
!               Config. -Delta1 (SIG=-1)
!               ========================
!...............Computes the spectrum values in 1, 2, 3
                SP1M  =F(IP,JT1M  ,JFM1)*CF1
                SP1M2P=F(IP,JT1M2P,JFM2)*CF2
                SP1M3M=F(IP,JT1M3M,JFM3)*CF3
                SP1M2M=F(IP,JT1M2M,JFM2)*CF2
                SP1M3P=F(IP,JT1M3P,JFM3)*CF3
!
!...............Computes auxiliary products and variables
                AUX01=SP0*V1_4+SP1M
                AUX02=SP0*SP1M
...
!...............Sum of Qnl4 term in the table TSTOT
                TSTOT(IP,JT    ,JFM0)=TSTOT(IP,JT    ,JFM0)+AUX00 *CP0
                TSTOT(IP,JT1M  ,JFM1)=TSTOT(IP,JT1M  ,JFM1)+AUX00 *CP1
                TSTOT(IP,JT1M2P,JFM2)=TSTOT(IP,JT1M2P,JFM2)-Q_2P3M*CP2
                TSTOT(IP,JT1M2M,JFM2)=TSTOT(IP,JT1M2M,JFM2)-Q_2M3P*CP2
                TSTOT(IP,JT1M3M,JFM3)=TSTOT(IP,JT1M3M,JFM3)-Q_2P3M*CP3
                TSTOT(IP,JT1M3P,JFM3)=TSTOT(IP,JT1M3P,JFM3)-Q_2M3P*CP3
!
!...............Sum of the term dQnl4/dF in the table TSDER
                TSDER(IP,JT    ,JFM0)=TSDER(IP,JT    ,JFM0)+AUX09 *CP0
                TSDER(IP,JT1M  ,JFM1)=TSDER(IP,JT1M  ,JFM1)+AUX10 *CP1
                TSDER(IP,JT1M2P,JFM2)=TSDER(IP,JT1M2P,JFM2)-Q2PD2P*CP2
                TSDER(IP,JT1M2M,JFM2)=TSDER(IP,JT1M2M,JFM2)-Q2MD2M*CP2
                TSDER(IP,JT1M3M,JFM3)=TSDER(IP,JT1M3M,JFM3)-Q2PD3M*CP3
                TSDER(IP,JT1M3P,JFM3)=TSDER(IP,JT1M3P,JFM3)-Q2MD3P*CP3
!
              ENDIF
!
            ENDDO
