...
C
C***********************************************************************
C BIEF VERSION 5.1           21/09/93    J-M HERVOUET (LNH) 30 87 80 18
...
C
C            L'ELEMENT DE LIGNE EST A TROIS POINTS
C            L'ELEMENT DE LIGNE EST A 4     POINTS
C
...
5          FORMAT(1X,'OM1112 (BIEF) : TYPDIN INCONNU :',A1)
...
10        FORMAT(1X,'OM1112 (BIEF) : TYPEXN INCONNU :',A1)
...
99          FORMAT(1X,'OM1112 (BIEF) : TYPEXM = ',A1,' NE CONVIENT PAS',
...
C
C   CONTRIBUTION DE LA DIAGONALE (ICI DM ET D NE SONT PAS DU MEME TYPE )
C
...
12         FORMAT(1X,'OM1112 (BIEF) : TYPDIM INCONNU :',A1)
...
C
         ELSEIF(TYPEXM(1:1).NE.'0') THEN
          IF (LNG.EQ.1) WRITE(LU,162)
          IF (LNG.EQ.2) WRITE(LU,163)
162       FORMAT(1X,'OM1112 (BIEF) : TYPEXM NON PREVU : ',A1)
...
710       FORMAT(1X,'OM1112 (BIEF) : TYPEXM INCONNU :',A1)
...
40      FORMAT(1X,'OM1112 (BIEF) : OPERATION INCONNUE : ',A8)
