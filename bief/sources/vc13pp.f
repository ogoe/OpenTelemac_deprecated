...
C
C***********************************************************************
C BIEF VERSION 6.0       19/05/2010   J-M HERVOUET (LNHE) 01 30 87 80 18
C 
C
C 19/05/2010 JMH: NEW FILTER FOR PARTLY CRUSHED ELEMENTS
C                 IF FORMUL(7:7).EQ.'2'
C                                     
C***********************************************************************
C
...
!        VERSION LUMPEE (COMME LA MATRICE DE DIFFUSION)
...
C
C     TRAITEMENT COMMUN AUX FILTRES 2,3 ET 4
C
...
C
          ...
          Z6 = Z(I6)
C
C         CHECKING IF A STRATIFICATION IS IMPOSSIBLE
