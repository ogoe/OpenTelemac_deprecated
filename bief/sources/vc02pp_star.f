...
1000    FORMAT(1X,'VC02PP_STAR (BIEF) : TYPE DE F NON PREVU : ',I6)
...
2000    FORMAT(1X,'VC02PP_STAR (BIEF) : TYPE DE G NON PREVU : ',I6)
...
3000    FORMAT(1X,'VC02PP_STAR (BIEF) : TYPE DE H NON PREVU : ',I6)
3001    FORMAT(1X,'VC02PP_STAR (BIEF) : TYPE OF H NOT IMPLEMENTED: ',I6)
        CALL PLANTE(1)
        STOP
      ENDIF
      IF(SU%ELM.NE.41) THEN
        IF (LNG.EQ.1) WRITE(LU,2000) SU%ELM
        IF (LNG.EQ.2) WRITE(LU,2001) SU%ELM
4000    FORMAT(1X,'VC02PP_STAR (BIEF) : TYPE DE U NON PREVU : ',I6)
