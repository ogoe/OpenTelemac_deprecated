...
C***********************************************************************
C
C FONCTION : DONNE LE NOMBRE DE POINTS PAR ELEMENT POUR CHAQUE TYPE
C            D'ELEMENT.
C
C-----------------------------------------------------------------------
C                             ARGUMENTS
...
C
 ...
 200     FORMAT(1X,'NBPEL (BIEF) : MAUVAIS ARGUMENT : ',1I6)
 201     FORMAT(1X,'NBPEL (BIEF) : WRONG ARGUMENT: ',1I6)
         CALL PLANTE(1)
         STOP
       ELSE
        NBPEL = NDS(IELM,3)
