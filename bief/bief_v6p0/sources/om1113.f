...
C
C***********************************************************************
C BIEF VERSION 5.9           13/02/08    ALGIANE FROEHLY (MATMECA)
...
5          FORMAT(1X,'OM1113 (BIEF) : TYPDIN INCONNU :',A1)
...
10        FORMAT(1X,'OM1113 (BIEF) : TYPEXN INCONNU :',A1)
...
99          FORMAT(1X,'OM1113 (BIEF) : TYPEXM = ',A1,' NE CONVIENT PAS',
...
12         FORMAT(1X,'OM1113 (BIEF) : TYPDIM INCONNU :',A1)
...
C
         ELSEIF(TYPEXM(1:1).NE.'0') THEN
          IF (LNG.EQ.1) WRITE(LU,162)
          IF (LNG.EQ.2) WRITE(LU,163)
162       FORMAT(1X,'OM1113 (BIEF) : TYPEXM NON PREVU : ',A1)
...
710       FORMAT(1X,'OM1113 (BIEF) : TYPEXM INCONNU :',A1)
...
40      FORMAT(1X,'OM1113 (BIEF) : OPERATION INCONNUE : ',A8)
