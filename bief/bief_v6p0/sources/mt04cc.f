...
C
C***********************************************************************
C BIEF VERSION 5.9           01/06/08    A FROEHLY (MATMECA) 
C***********************************************************************
C
...
C
C          PI DE DISCRETISATION P2
C          PJ DE DISCRETISATION P2
C
C-----------------------------------------------------------------------
C                             ARGUMENTS
...
C
C
C  ON CALCULE 15 DES 36 TERMES (CHOISIS PARMI LES MOINS COMPLEXES)
C
C
...
C-----------------------------------------------------------------------
C
C  DISCRETISATION P2 DE LA VITESSE :
C
      DO 5 IELEM = 1 , NELEM
C
C   INITIALISATION DES VARIABLES GEOMETRIQUES
...
C
C
C TERMES RESTANTS OBTENUS PAR PROPRIETE DE CARRE MAGIQUE
C (SOMME DES LIGNES = SOMME DES COLONNES = VECTEUR NUL)
C
         A16(IELEM) = - A11(IELEM) - A12(IELEM) - A13(IELEM) 
     *                - A14(IELEM) - A15(IELEM)
