C
C     INTERFACES OF BIEF PUBLIC SUBROUTINES
C
      MODULE BIEF
C
C=======================================================================
...
C           
        ...
        END SUBROUTINE         
C          
        SUBROUTINE ALLMAT(MAT,NOM,IELM1,IELM2,CFG,TYPDIA,TYPEXT)
        USE BIEF_DEF
        IMPLICIT NONE
        ...
        END SUBROUTINE        
C          
        SUBROUTINE ALLVEC( NAT , VEC , NOM , IELM , DIM2 , STATUT )
          USE BIEF_DEF
          IMPLICIT NONE
        ...
        END SUBROUTINE        
C          
        SUBROUTINE ALLVEC_IN_BLOCK(BLO,N,NAT,NOMGEN,IELM,NDIM,STATUT)
          USE BIEF_DEF
          IMPLICIT NONE
          TYPE(BIEF_OBJ), INTENT(INOUT) :: BLO
...
C          
     ...
     *                    NELMAX,IELM,W,INIT,LV,MSK,MASKEL)
          USE BIEF_DEF
          IMPLICIT NONE
          DOUBLE PRECISION, INTENT(INOUT)::X(*)
...
!
!     JMH LE 13/02/2008 :
!     LE COMPILATEUR HP ACCEPTE UN NOMBRE LIMITE DE ROUTINES
!     J'ENLEVE CELLES-LA POUR L'INSTANT
!
!         
...
C                  
     ...
     *(U,V,X,Y,SHP,ELT,IKLE,INDIC,NLOC,NPOIN,NELEM,NELMAX,LV,MSK,MASKEL)
      ...
      LOGICAL, INTENT(IN) :: MSK
        END SUBROUTINE        
C          
        SUBROUTINE GTSH13(U,V,X,Y,SHP,ELT,IKLE,INDIC,NLOC,NPOIN,
...
C          
     ...
     *   NVMAX , NELEM , NELMAX , NSEG ,CMI ,JMI ,AIRST)
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: AIRST(2,*) 
        END SUBROUTINE        
C          
        SUBROUTINE ININDS(NPOIN,NPTFR,NELEM,NPMAX,NPTFX,
     *                    NELMAX,NPLAN,NSEGBOR,NELEB)
          IMPLICIT NONE
...
C          
     ...
     *(MXPTVS,MXELVS,IKLES,IELM,NPOIN,NELEM,NDP,IPOBO,LISTIN)
      ...
      LOGICAL, INTENT(IN)    :: LISTIN
        END SUBROUTINE        
C          
        INTEGER FUNCTION NBFEL(IELM)
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
        END FUNCTION        
C           
        INTEGER FUNCTION NBMPTS(IELM)
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
        END FUNCTION         
C          
        INTEGER FUNCTION NBPEL(IELM)
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
        END FUNCTION        
C          
        INTEGER FUNCTION NBPTS(IELM)
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
        END FUNCTION        
C          
        INTEGER FUNCTION NBSEG(IELM)
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
        END FUNCTION        
C          
        INTEGER FUNCTION NBSEGEL(IELM)
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
        END FUNCTION        
C          
...
C          
     ...
     *(KNOGL,DIM1_KNOGL,KNOLG,NBOR,NACHB,NPTFR,NPOIN)
      USE BIEF_DEF
      IMPLICIT NONE
C     DIMENSIONS WITH NPTIR HAVE BEEN REPLACED BY *
C     THOUGH NPTIR IS ABOVE, IT IS NOT SEEN (?)
...
C
     ...
     * SMH,YASMH,OPTSOU,FLULIM,LIMPRO,HBOR,KDIR,INFO,FLOPOINT)
      ...
      INTEGER, INTENT(IN)           :: GLOSEG1(*),GLOSEG2(*),NBOR(NPTFR)
...
C          
      ...
      INTEGER, INTENT(OUT) :: IPOBO(NPOIN)
        END SUBROUTINE        
C          
        SUBROUTINE READGEO3(KNOLG,X,Y,NPOIN,NFIC,IB,Z)
          USE BIEF_DEF
          IMPLICIT NONE
