...
C
      ...
      KYEL =  G(IELEM)
C
C  ON CALCULE 30 DES 36 TERMES (CHOISIS PARMI LES MOINS COMPLEXES)
C
...
C
C-----------------------------------------------------------------------
C CAS OU U EST DE DISCRETISATION P2
C-----------------------------------------------------------------------
C
