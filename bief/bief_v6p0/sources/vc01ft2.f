...
C
C***********************************************************************
C BIEF VERSION 5.9         26/04/04    J-M HERVOUET (LNH) 01 30 87 80 18
...
C
C                    /
C    VEC(I) = XMUL  /    PSI(I) * F * G * D(OMEGA)
C                  /OMEGA
C
C
...
C    G EST UN VECTEUR DE TYPE IELMG
C
...
C-----------------------------------------------------------------------
C
C     F LINEAIRE ET CONSTANT PAR FACE DE BORD
C
