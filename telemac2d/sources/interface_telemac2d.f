C
C  INTERFACES OF TELEMAC-2D SUBROUTINES
C
...
C
      INTERFACE
        SUBROUTINE CALDT(NS,G,H,U,V,DTHAUT,DT,CFL)
      IMPLICIT NONE
...
C
     ...
     * VOLU2D,V2DPAR,UNSV2D,NUMDIG,NWEIRS,NPSING,HFROT)
      USE BIEF_DEF
      IMPLICIT NONE
...
C
     ...
     * NFRLIQ,THOMFR,DEBLIQ,FINLIQ,FRTYPE,XNEBOR,YNEBOR,ENTET,MESH)
      ...
      INTEGER, INTENT(IN) :: LIUBOR(NPTFR),FRTYPE(*),LIMDIM,IELMU
      INTEGER, INTENT(IN) :: DEBLIQ(NFRLIQ),FINLIQ(NFRLIQ)
...
C
     ...
     * ITRAV2,W1R,W2R,W3R,W4R,HBTIL,UBTIL,VBTIL,TBTIL,ZBTIL,SURDET,IKLE,
