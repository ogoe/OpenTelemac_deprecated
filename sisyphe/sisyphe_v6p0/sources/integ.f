...
C                                                                               
C***********************************************************************        
C SISYPHE VERSION 5.5                                           20/05/96
C                                                Modifs EBS/TB    2000    
C                                                
C COPYRIGHT EDF-DTMPL-SOGREAH-LHF-GRADIENT                                                            
C***********************************************************************        
C                                                                               
C      FONCTION: CALCULE L'INTEGRALE D'EINSTEIN 
C                POUR LE TRANSPORT EN SUSPENSION:
C
C                              A-1     /1       A
C                             B       |  / 1-y  \     33y
C           I = 0.216*1.83 * ------ * | | ----- | Ln --- dy
C                                 A   |  \  y   /      B                                  
C                            (1-B)    /B                      
C
C                          Ws                   kr
...
C                  kappa * beta * U*cw          h
C
C      DES VALEURS - CALCULEES PAR SIMPSON - SONT TABULEES
C      ET INTERPOLEES LINEAIREMENT.
C
C-----------------------------------------------------------------------        
C                             ARGUMENTS                                         
...
C                                                                               
C RAPPORT QSS/QSC                                                               
C CALCULE A PARTIR DES INTEGRALES D'EINSTEIN                                    
C ET GENERE PAR MAPLE V                                                         
C                                                                               
C DONNEES POUR A=  .0                                                           
C                                                                               
...
C TRAITEMENT DE B ET DE A                                                    
C =======================
C                                                    
C CAS SUSPENSION NEGLIGEABLE
C                                              
C
            IF (A(I).GT.AEIN(LNA).OR.(B(I).GE.1.D0)) THEN                                           
               IEIN(I) = 0.D0                                                       
C
C VALEURS EN DEHORS DE LA TABLE
C                                           
...
C                                                                               
               ...
               STOP
C                                                             
C VALEURS DANS LA TABLE
C                                                   
            ELSE                                                                
C                                                                               
C RECHERCHE DE L'ENCADREMENT DE B                                            
C ===============================
C                                           
               INF = 1                                                          
               SUP = LNB                                                        
C----DEBUT DE BOUCLE DO WHILE----                                               
 51            MIL = (INF + SUP ) / 2                                           
...
C----FIN DE BOUCLE DO WHILE----                                                 
               JT=SUP                                                           
               B1 = BEIN(INF)                                                   
               B2 = BEIN(SUP)                                                   
C                                                                               
C RECHERCHE DE L'ENCADREMENT DE A                                               
C ===============================
C                                               
               INF = 1                                                          
               SUP = LNA                                                        
...
C----FIN DE BOUCLE DO WHILE----                                                 
               ...
               A2 = AEIN(SUP)                                                   
C                                                                               
C CALCUL DE L'INTEGRALE IEIN                                                    
C ==========================
C                                                     
C INTERPOLATION A A1 CONSTANT                                                    
               INT1 = (EINJ3(JT-1,IT-1)-EINJ3(JT,IT-1))/(B1-B2)*
     *                (B(I)-B1) + EINJ3(JT-1,IT-1)                                          
C INTERPOLATION A A2 CONSTANT                                                    
               INT2 = (EINJ3(JT-1,IT)  -EINJ3(JT,IT)  )/(B1-B2)*
     *                (B(I)-B1) + EINJ3(JT-1,IT)                                            
C REINTERPOLATION ENTRE LES DEUX VALEURS PRECEDENTES                             
